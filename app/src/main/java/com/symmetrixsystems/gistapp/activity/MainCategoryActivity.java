...
import com.symmetrixsystems.gistapp.async.UserSelectionTask;
...
import com.symmetrixsystems.gistapp.model.MainCategoryData;
...
import com.symmetrixsystems.gistapp.customlists.IconCatOffsetDecoration;
import com.symmetrixsystems.gistapp.customlists.IconCategoryAdapter;
import com.symmetrixsystems.gistapp.customlists.MainCategoryAdapter;
...
public class MainCategoryActivity extends AppCompatActivity implements SelectionsListener, SelectedChildListener, UserSelectionsListener {
    ...
    private ImageView ivEvacado, ivControl, ivSelection;
...
*/
    ...
    public void onMainCategoryClick(int categoryId, String categoryName) {
        ...
        if (popUpChildcat == null || !popUpChildcat.isShowing()) {
            ...
            View popupView = layoutInflater.inflate(R.layout.popup_selection, null);
            ...
            popUpChildcat.setOutsideTouchable(false);
            //popupSearch.setOutsideTouchable(false);
            popUpChildcat.showAtLocation(layoutMain, Gravity.CENTER_HORIZONTAL, 0, 0);
