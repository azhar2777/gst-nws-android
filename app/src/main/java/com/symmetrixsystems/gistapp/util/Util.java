...
package com.symmetrixsystems.gistapp.util;
...
public class Util {
	...
	public static String postWithVolley(String hostName, String data, Context mContext, final VolleyCallback volleyCallback){
